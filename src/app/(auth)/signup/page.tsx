    ...
    <div className="min-h-screen bg-stone-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-8">
          <h1 className="font-serif text-2xl text-stone-900 mb-1">Begin your path</h1>
          <p className="text-sm text-stone-500 mb-6">Create a free account to start your first cycle.</p>
          ...
          <input
            ...
            placeholder="Password (min 8 characters)" onKeyDown={e => e.key === "Enter" && handleSignup()}
          ...
          <p className="text-center text-sm text-stone-500 mt-4">
            Already have one?{" "}
            <Link href="/login" className="text-stone-900 font-semibold underline underline-offset-2">
              Sign in
            </Link>
          </p>
        </div>
